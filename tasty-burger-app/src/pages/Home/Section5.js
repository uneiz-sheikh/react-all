            ...
            <Container>
                <Row className='align-items-center'>
                    <Col lg={6} className='text-center text-lg-start mb-5 mb-lg-0'>
                        ...
                        <Link to='/'>
                            <img src={StoreGoogle} alt='Anroid' className='img-fluid store me-3' />
                        </Link>
                    </Col>
                    <Col lg={6}>
                        ...
                        <Carousel.Item>                           
                            <Carousel.Caption>
                                <div className='d-flex align-items-center justify-content-between'>
                                    ...
                                    <div className='brand_img'>
                                        <img src={Brand3} className='img-fluid' alt='brand-4'/>
                                    </div>
                                    <div className='brand_img'>
                                        <img src={Brand4} className='img-fluid' alt='brand-5'/>
                                    </div>
                                    <div className='brand_img'>
